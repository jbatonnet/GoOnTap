...
public partial class Constants
{
    ...
    public static PokemonInfo[] Pokemons { get; } = new PokemonInfo[]
    {
        ...
        new PokemonInfo(252, "Treecko",    "Arcko",      "Geckarbor",  124, 104, 80),
        new PokemonInfo(253, "Grovyle",    "Massko",     "Reptain",    172, 130, 100),
        new PokemonInfo(254, "Sceptile",   "Jungko",     "Gewaldro",   223, 180, 140),
        new PokemonInfo(255, "Torchic",    "Poussifeu",  "Flemmli",    130, 92,  90),
        new PokemonInfo(256, "Combusken",  "Galifeu",    "Jungglut",   163, 115, 120),
        new PokemonInfo(257, "Blaziken",   "Braségali",  "Lohgock",    240, 141, 160),
        new PokemonInfo(258, "Mudkip",     "Gobou",      "Hydropi",    126, 93,  100),
        new PokemonInfo(259, "Marshtomp",  "Flobio",     "Moorabbel",  156, 133, 140),
        new PokemonInfo(260, "Swampert",   "Laggron",    "Sumpex",     208, 175, 200),
        new PokemonInfo(261, "Poochyena",  "Medhyèna",   "Fiffyen",    96,  63,  70),
        new PokemonInfo(262, "Mightyena",  "Grahyèna",   "Magnayen",   171, 137, 140),
        new PokemonInfo(263, "Zigzagoon",  "Zigzaton",   "Zigzachs",   58,  80,  76),
        new PokemonInfo(264, "Linoone",    "Linéon",     "Geradaks",   142, 128, 156),
        new PokemonInfo(265, "Wurmple",    "Chenipotte", "Waumpel",    75,  61,  90),
        new PokemonInfo(266, "Silcoon",    "Armulys",    "Schaloko",   60,  91,  100),
        new PokemonInfo(267, "Beautifly",  "Charmillon", "Papinella",  189, 98,  120),
        new PokemonInfo(268, "Cascoon",    "Blindalys",  "Panekon",    60,  91,  100),
        new PokemonInfo(269, "Dustox",     "Papinox",    "Pudox",      98,  172, 120),
        new PokemonInfo(270, "Lotad",      "Nénupiot",   "Loturzel",   71,  86,  80),
        new PokemonInfo(271, "Lombre",     "Lombre",     "Lombrero",   112, 128, 120),
        new PokemonInfo(272, "Ludicolo",   "Ludicolo",   "Kappalores", 173, 191, 160),
        new PokemonInfo(273, "Seedot",     "Grainipiot", "Samurzel",   71,  86,  80),
        new PokemonInfo(274, "Nuzleaf",    "Pifeuil",    "Blanas",     134, 78,  140),
        new PokemonInfo(275, "Shiftry",    "Tengalice",  "Tengulist",  200, 121, 180),
        new PokemonInfo(276, "Taillow",    "Nirondelle", "Schwalbini", 106, 61,  80),
        new PokemonInfo(277, "Swellow",    "Hélédelle",  "Schwalboss", 185, 130, 120),
        new PokemonInfo(278, "Wingull",    "Goélise",    "Wingull",    106, 61,  80),
        new PokemonInfo(279, "Pelipper",   "Bekipan",    "Pelipper",   175, 189, 120),
        new PokemonInfo(280, "Ralts",      "Tarsal",     "Trasla",     79,  63,  56),
        new PokemonInfo(281, "Kirlia",     "Kirlia",     "Kirlia",     117, 76,  100),
        new PokemonInfo(282, "Gardevoir",  "Gardevoir",  "Guardevoir", 237, 220, 136),
        new PokemonInfo(283, "Surskit",    "Arakdo",     "Gehweiher",  93,  97,  80),
        new PokemonInfo(284, "Masquerain", "Maskadra",   "Maskeregen", 192, 161, 140),
        new PokemonInfo(285, "Shroomish",  "Balignon",   "Knilz",      74,  110, 120),
        new PokemonInfo(286, "Breloom",    "Chapignon",  "Kapilz",     241, 153, 120),
        new PokemonInfo(287, "Slakoth",    "Parecool",   "Bummelz",    104, 104, 120),
        new PokemonInfo(288, "Vigoroth",   "Vigoroth",   "Muntier",    159, 159, 160),
        new PokemonInfo(289, "Slaking",    "Monaflèmit", "Letarking",  290, 183, 273),
        new PokemonInfo(290, "Nincada",    "Ningale",    "Nincada",    80,  153, 62),
        new PokemonInfo(291, "Ninjask",    "Ninjask",    "Ninjask",    196, 114, 122),
        new PokemonInfo(292, "Shedinja",   "Munja",      "Ninjatom",   153, 80,  2),
        new PokemonInfo(293, "Whismur",    "Chuchmur",   "Flurmel",    92,  42,  128),
        new PokemonInfo(294, "Loudred",    "Ramboum",    "Krakeelo",   134, 81,  168),
        new PokemonInfo(295, "Exploud",    "Brouhabam",  "Krawumms",   179, 142, 208),
        new PokemonInfo(296, "Makuhita",   "Makuhita",   "Makuhita",   99,  54,  144),
        new PokemonInfo(297, "Hariyama",   "Hariyama",   "Hariyama",   209, 114, 288),
        new PokemonInfo(298, "Azurill",    "Azurill",    "Azurill",    36,  71,  100),
        new PokemonInfo(299, "Nosepass",   "Tarinor",    "Nasgnet",    82,  236, 60),
        new PokemonInfo(300, "Skitty",     "Skitty",     "Eneco",      84,  84,  100),
        new PokemonInfo(301, "Delcatty",   "Delcatty",   "Enekoro",    132, 132, 140),
        new PokemonInfo(302, "Sableye",    "Ténéfix",    "Zobiris",    141, 141, 100),
        new PokemonInfo(303, "Mawile",     "Mysdibule",  "Flunkifer",  155, 155, 100),
        new PokemonInfo(304, "Aron",       "Galekid",    "Stollunior", 121, 168, 100),
        new PokemonInfo(305, "Lairon",     "Galegon",    "Stollrak",   158, 240, 120),
        new PokemonInfo(306, "Aggron",     "Galeking",   "Stolloss",   198, 314, 140),
        new PokemonInfo(307, "Meditite",   "Méditikka",  "Meditie",    78,  107, 60),
        new PokemonInfo(308, "Medicham",   "Charmina",   "Meditalis",  121, 152, 120),
        new PokemonInfo(309, "Electrike",  "Dynavolt",   "Frizelbliz", 123, 78,  80),
        new PokemonInfo(310, "Manectric",  "Élecsprint", "Voltenso",   215, 127, 140),
        new PokemonInfo(311, "Plusle",     "Posipi",     "Plusle",     167, 147, 120),
        new PokemonInfo(312, "Minun",      "Négapi",     "Minun",      147, 167, 120),
        new PokemonInfo(313, "Volbeat",    "Muciole",    "Volbeat",    143, 171, 130),
        new PokemonInfo(314, "Illumise",   "Lumivole",   "Illumise",   143, 171, 130),
        new PokemonInfo(315, "Roselia",    "Rosélia",    "Roselia",    186, 148, 100),
        new PokemonInfo(316, "Gulpin",     "Gloupti",    "Schluppuck", 80,  99,  140),
        new PokemonInfo(317, "Swalot",     "Avaltout",   "Schlukwech", 140, 159, 200),
        new PokemonInfo(318, "Carvanha",   "Carvanha",   "Kanivanha",  171, 39,  90),
        new PokemonInfo(319, "Sharpedo",   "Sharpedo",   "Tohaido",    243, 83,  140),
        new PokemonInfo(320, "Wailmer",    "Wailmer",    "Wailmer",    136, 260, 68),
        new PokemonInfo(321, "Wailord",    "Wailord",    "Wailord",    175, 87,  340),
        new PokemonInfo(322, "Numel",      "Chamallot",  "Camaub",     119, 120, 82),
        new PokemonInfo(323, "Camerupt",   "Camérupt",   "Camerupt",   194, 139, 140),
        new PokemonInfo(324, "Torkoal",    "Chartor",    "Qurtel",     151, 234, 140),
        new PokemonInfo(325, "Spoink",     "Spoink",     "Spoink",     125, 145, 120),
        new PokemonInfo(326, "Grumpig",    "Groret",     "Groink",     171, 211, 160),
        new PokemonInfo(327, "Spinda",     "Spinda",     "Pandir",     116, 116, 120),
        new PokemonInfo(328, "Trapinch",   "Kraknoix",   "Knacklion",  162, 78,  90),
        new PokemonInfo(329, "Vibrava",    "Vibraninf",  "Vibrava",    134, 99,  100),
        new PokemonInfo(330, "Flygon",     "Libégon",    "Libelldra",  205, 168, 160),
        new PokemonInfo(331, "Cacnea",     "Cacnea",     "Tuska",      156, 74,  100),
        new PokemonInfo(332, "Cacturne",   "Cacturne",   "Noktuska",   221, 115, 140),
        new PokemonInfo(333, "Swablu",     "Tylton",     "Wablu",      76,  139, 90),
        new PokemonInfo(334, "Altaria",    "Altaria",    "Altaria",    141, 208, 150),
        new PokemonInfo(335, "Zangoose",   "Mangriff",   "Sengo",      222, 124, 146),
        new PokemonInfo(336, "Seviper",    "Séviper",    "Vipitis",    196, 118, 146),
        new PokemonInfo(337, "Lunatone",   "Séléroc",    "Lunastein",  178, 163, 180),
        new PokemonInfo(338, "Solrock",    "Solaroc",    "Sonnfel",    178, 163, 180),
        new PokemonInfo(339, "Barboach",   "Barloche",   "Schmerbe",   93,  93,  100),
        new PokemonInfo(340, "Whiscash",   "Barbicha",   "Welsar",     151, 142, 220),
        new PokemonInfo(341, "Corphish",   "Écrapince",  "Krebscorps", 141, 113, 86),
        new PokemonInfo(342, "Crawdaunt",  "Colhomard",  "Krebutack",  224, 156, 126),
        new PokemonInfo(343, "Baltoy",     "Balbuto",    "Puppance",   77,  131, 80),
        new PokemonInfo(344, "Claydol",    "Kaorine",    "Lepumentas", 140, 236, 120),
        new PokemonInfo(345, "Lileep",     "Lilia",      "Liliep",     105, 154, 132),
        new PokemonInfo(346, "Cradily",    "Vacilys",    "Wielie",     152, 198, 172),
        new PokemonInfo(347, "Anorith",    "Anorith",    "Anorith",    176, 100, 90),
        new PokemonInfo(348, "Armaldo",    "Armaldo",    "Armaldo",    222, 183, 150),
        new PokemonInfo(349, "Feebas",     "Barpau",     "Barschwa",   29,  102, 40),
        new PokemonInfo(350, "Milotic",    "Milobellus", "Milotic",    192, 242, 190),
        new PokemonInfo(351, "Castform",   "Morphéo",    "Formeo",     139, 139, 140),
        new PokemonInfo(352, "Kecleon",    "Kecleon",    "Kecleon",    161, 212, 120),
        new PokemonInfo(353, "Shuppet",    "Polichombr", "Shuppet",    138, 66,  88),
        new PokemonInfo(354, "Banette",    "Branette",   "Banette",    218, 127, 128),
        new PokemonInfo(355, "Duskull",    "Skelénox",   "Zwirrlicht", 70,  162, 40),
        new PokemonInfo(356, "Dusclops",   "Téraclope",  "Zwirrklop",  124, 234, 80),
        new PokemonInfo(357, "Tropius",    "Tropius",    "Tropius",    136, 165, 198),
        new PokemonInfo(358, "Chimecho",   "Éoko",       "Palimpalim", 175, 174, 150),
        new PokemonInfo(359, "Absol",      "Absol",      "Absol",      246, 120, 130),
        new PokemonInfo(360, "Wynaut",     "Okéoké",     "Isso",       41,  86,  190),
        new PokemonInfo(361, "Snorunt",    "Stalgamin",  "Schneppke",  95,  95,  100),
        new PokemonInfo(362, "Glalie",     "Oniglali",   "Firnontor",  162, 162, 160),
        new PokemonInfo(363, "Spheal",     "Obalie",     "Seemops",    95,  90,  140),
        new PokemonInfo(364, "Sealeo",     "Phogleur",   "Seejong",    137, 132, 180),
        new PokemonInfo(365, "Walrein",    "Kaimorse",   "Walraisa",   182, 176, 220),
        new PokemonInfo(366, "Clamperl",   "Coquiperl",  "Perlu",      133, 149, 70),
        new PokemonInfo(367, "Huntail",    "Serpang",    "Aalabyss",   197, 194, 110),
        new PokemonInfo(368, "Gorebyss",   "Rosabyss",   "Saganabyss", 211, 194, 110),
        new PokemonInfo(369, "Relicanth",  "Relicanth",  "Relicanth",  162, 234, 200),
        new PokemonInfo(370, "Luvdisc",    "Lovdisc",    "Liebiskus",  81,  134, 86),
        new PokemonInfo(371, "Bagon",      "Draby",      "Kindwurm",   134, 107, 90),
        new PokemonInfo(372, "Shelgon",    "Drackhaus",  "Draschel",   172, 179, 130),
        new PokemonInfo(373, "Salamence",  "Drattak",    "Brutalanda", 277, 168, 190),
        new PokemonInfo(374, "Beldum",     "Terhal",     "Tanhel",     96,  141, 80),
        new PokemonInfo(375, "Metang",     "Métang",     "Metang",     138, 185, 120),
        new PokemonInfo(376, "Metagross",  "Métalosse",  "Metagross",  257, 247, 160),
        new PokemonInfo(377, "Regirock",   "Regirock",   "Regirock",   179, 285, 160),
        new PokemonInfo(378, "Regice",     "Regice",     "Regice",     179, 285, 160),
        new PokemonInfo(379, "Registeel",  "Registeel",  "Registeel",  143, 285, 160),
        new PokemonInfo(380, "Latias",     "Latias",     "Latias",     228, 268, 160),
        new PokemonInfo(381, "Latios",     "Latios",     "Latios",     268, 228, 160),
        new PokemonInfo(382, "Kyogre",     "Kyogre",     "Kyogre",     270, 251, 182),
        new PokemonInfo(383, "Groudon",    "Groudon",    "Groudon",    270, 251, 182),
        new PokemonInfo(384, "Rayquaza",   "Rayquaza",   "Rayquaza",   284, 170, 191),
        new PokemonInfo(385, "Jirachi",    "Jirachi",    "Jirachi",    210, 210, 200),
        new PokemonInfo(386, "Deoxys",     "Deoxys",     "Deoxys",     1,   1,   1),
    };
}
